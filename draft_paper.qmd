...
*Question: Should we start with some simple descriptive statistics for the entire data set here or at the beginning of the results? Like which sites had the most species/hits, which days had the most species/hits, which species were most common, etc.* YES

*Thought: I actually think we can start with 'MH graph' even though we did a lot of work with the probability plots in the beginning. It was only after 'MH graph' that we realized what temporal scale around the eclipse we wanted.* YES
