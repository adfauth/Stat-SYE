...
```{r, out.width = "100%", fig.height = 4, fig.align = "center"}
# days
...
ggplot(three_day, aes(time, Presence))+
  ...
  scale_x_time()+
  labs(x = "Time")+
  #scale_x_continuous(name = "Time", breaks = c(hms(30,55,14), hms(30,25,15), hms(30,55,15)))+
...
- $\pi_{id}$ is the probability of detecting a species for the $i^{th}$ observation recorded on the $a^{th}$ audiomoth($a = 1, 2, \ldots, 20$) on the $d^{th}$ day of recording ($d = 1, 2, 3, 4, 5$).
